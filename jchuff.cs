...
// that are shared between the sequential encoder (jchuff.cs), the
// progressive encoder (jcphuff.cs). and the lossless encoder (jclhuff.cs). 
...
namespace Free.Ports.LibJpeg
{
	public static partial class libjpeg
	{
		...
		class c_derived_tbl 
		{
			...
			public byte[] ehufsi=new byte[256];	// length of code for each symbol
